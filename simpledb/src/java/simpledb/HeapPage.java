...
public class HeapPage implements Page {
	...
	private int getHeaderSize() {
		// defined as equal to ceiling(no. tuple slots / 8)
	...
	public void deleteTuple(Tuple t) throws DbException {
		...
		if (!this.isSlotUsed(tupleSlot)) {
			throw new DbException("Tuple slot already empty");
		}
		
		this.tuples[tupleSlot] = null;
		this.markSlotUsed(tupleSlot, false);
	}
	...
	public void insertTuple(Tuple t) throws DbException {
		// some code goes here
		// not necessary for lab1
		// note we don't mark pages dirty here we do that in the caller function
		if(this.getNumEmptySlots() == 0) {
			throw new DbException("No Empty slots on page");
		}
		if(!t.getTupleDesc().equals(this.td)) {
			throw new DbException("Tuple desc does not match page td");
		}
...
//				++slotsCounted;
//				int mask = 1 << j;
//				int isEmpty = (mask & b) == 0 ? 1 : 0;
//				emptySlots += isEmpty;
//				if (slotsCounted == this.numSlots) {
//					return emptySlots;
//				}
//			}
//		}
//		return emptySlots;
	...
	public boolean isSlotUsed(int i) {
		// some code goes here
		// get the index of byte then create mask then
		int index = Math.floorDiv(i, 8);
		int mask = (1 << (i % 8));
		return (this.header[index] & mask) != 0;
	...
	public Iterator<Tuple> iterator() {
		...
		ArrayList<Tuple> tupleList = new ArrayList<Tuple>(Arrays.asList(this.tuples));

		// Remove any empty tuples
		tupleList.removeAll(Collections.singleton(null));
